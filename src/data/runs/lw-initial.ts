...
export const productionSKUData = {
  "OB24": {
    initialStartingInventory: LW_STARTING_INV["OB24"],
  ...
  "MH24": {
    initialStartingInventory: LW_STARTING_INV["MH24"],
  ...
  "TK24": {
    initialStartingInventory: LW_STARTING_INV["TK24"],
  ...
  "HC24": {
    initialStartingInventory: LW_STARTING_INV["HC24"],
  ...
  "VP12": {
    initialStartingInventory: LW_STARTING_INV["VP12"],
...
export const kittingPlanData = [
  {
    ...
    targetWOS: [6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6],
    kitCenters: [
      { name: "SB Kitting", weeklyCapacity: Array(16).fill(810), weeklyPlanned: [264, 394, 686, 525, 655, 561, 700, 521, 477, 525, 463, 383, 324, 324, 336, 343] },
  ...
  },
  {
    ...
    kitCenters: [
      { name: "SB Kitting", weeklyCapacity: Array(16).fill(630), weeklyPlanned: [199, 296, 517, 397, 494, 424, 528, 393, 361, 396, 349, 289, 245, 245, 252, 259] },
      { name: "Midwest Kitting", weeklyCapacity: Array(16).fill(360), weeklyPlanned: [85, 127, 221, 170, 212, 181, 226, 169, 154, 169, 150, 124, 105, 105, 108, 111] },
    ],
  },
  {
    sku: "TK24",
    ...
    kitCenters: [
      ...
      { name: "Midwest Kitting", weeklyCapacity: Array(16).fill(270), weeklyPlanned: [66, 99, 172, 133, 165, 142, 176, 131, 121, 132, 117, 97, 82, 82, 84, 86] },
    ],
  },
]
...
export const materialsPlanData = [
  {
    ...
    coManConsumption: [
      { coMan: "San Bernardino Facility", materialRequirement: [936, 900, 972, 954, 918, 936, 990, 954, 900, 954, 972, 936, 918, 954, 936, 972] },
      { coMan: "Midwest Meat Co", materialRequirement: [864, 828, 900, 882, 846, 864, 918, 882, 828, 882, 900, 864, 846, 882, 864, 900] },
      { coMan: "Pacific Jerky Works", materialRequirement: [630, 612, 666, 648, 630, 630, 684, 648, 612, 648, 666, 630, 630, 648, 630, 666] },
    ],
    suppliers: [
      { name: "Premium Beef Supply", coMansServed: ["San Bernardino Facility", "Midwest Meat Co"], materialRequirement: [1800, 1728, 1872, 1836, 1764, 1800, 1908, 1836, 1728, 1836, 1872, 1800, 1764, 1836, 1800, 1872], yieldFactor: 0.98 },
      { name: "Spice & Marinade Co", coMansServed: ["Pacific Jerky Works"], materialRequirement: [630, 612, 666, 648, 630, 630, 684, 648, 612, 648, 666, 630, 630, 648, 630, 666], yieldFactor: 0.97 },
    ],
  ...
  {
    material: "Original Marinade Blend",
    canonicalUnit: "kg",
    coManConsumption: [
      { coMan: "San Bernardino Facility", materialRequirement: [504, 486, 540, 522, 504, 504, 558, 522, 486, 522, 540, 504, 504, 522, 504, 540] },
      { coMan: "Midwest Meat Co", materialRequirement: [432, 414, 450, 432, 414, 432, 450, 450, 414, 432, 450, 432, 414, 432, 432, 432] },
    ],
    suppliers: [
      { name: "Premium Beef Supply", coMansServed: ["San Bernardino Facility", "Midwest Meat Co"], materialRequirement: [936, 900, 990, 954, 918, 936, 1008, 972, 900, 954, 990, 936, 918, 954, 936, 972], yieldFactor: 0.96 },
    ],
