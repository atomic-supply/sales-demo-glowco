// ============================================================================
// CENTRALIZED APPLICATION CONFIGURATION — GLOWCO
// ============================================================================
...
export const MODULES: ModuleDefinition[] = [
  ...
  { id: "production", name: "Production Planning", shortName: "Production", description: "Formulation production by product line across co-man sites", unit: "Units", color: "#F59E0B" },
  { id: "kitting", name: "Kitting", shortName: "Kitting", description: "Assembly and packaging of finished goods", unit: "Units", color: "#10B981" },
  { id: "mrp", name: "MRP (Material Requirements)", shortName: "MRP", description: "Raw material and packaging procurement", unit: "Units", color: "#EF4444" },
